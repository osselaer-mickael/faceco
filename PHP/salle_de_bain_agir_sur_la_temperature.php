...
<body>
    ...
    <div id="electricite">
        <div id="container_title">
            <h2>Agir sur l'électricité</h2>
        </div>
        <div id="text_one_elec">
            <p>Laver son linge a 30°</p>
            <span>= 3x moins d'électricité qu’à 90°C</span>
        </div>
        <div id="text_two_elec">
            <p>Laisser sécher son linge à l’air libre</p>
            <span>Le sèche-linge est très gourmand en électricité</span>
        </div>
        <div id="text_three_elec">
            <p>Je me lave les mains à l’eau froide</p>
            <span>Pas la peine d’allumer l’eau chaude : le temps que je me lave les mains, l’eau aura à peine le temps
                de chauffer !
            </span>
        </div>
    </div>
    <div id="eau">
        ...
        <div id="text_three_eau">
            ...
            <span>1 bain = 3 douches</span>
        </div>
        <div id="text_four_eau">
            <p>Installer un mousseur sur le robinet</p>
            <span>un mousseur réduit de 30 à 50% le débit du robinet</span>
        </div>
        <div id="text_five_eau">
            <p>Je coupe l’eau qui coule inutilement</p>
            <span>un robinet qui goutte = 120 litres/jour en moyenne</span>
        </div>
        <div id="text_six_eau">
            <p>Installez un WC avec une chasse d’eau ECO</p>
            <span>une chasse d’eau à double débit consomme entre 3 et 6 litres d’eau, elle permet une économie annuelle
                de 30 ㎥ pour une famille de 4 personnes
            </span>
        </div>
        <div id="text_seven_eau">
            <p>Repérez les fuites et réparez-les rapidement</p>
            <span>une chasse d’eau qui fuit = plus de 600 litres/jour</span>
        </div>
